...
export async function generateLlmEnrichment(
  ...
  const prompt = [
    ...
    "6. suggested_meaning should be a concise Simplified Chinese explanation for the learner.",
    'JSON keys: normalized_phrase, suggested_correction, correction_notes, suggested_meaning, suggested_group_label, suggested_word_type, suggested_synonyms, suggested_antonyms, suggested_example_sentence, suggested_example_context, usage_intent, difficulty, review_priority, confidence, suggestion_source.',
    'suggested_word_type should be one of: "word", "phrase", "sentence pattern", "verb", "noun", "adjective", "adverb".',
  ...
  return {
    ...
    suggested_word_type: normalizeOptionalString(parsed.suggested_word_type),
